...
# Instruction
   ...
   Please note: the Pareto optimal set in this code for the six problems is: <img src="https://render.githubusercontent.com/render/math?math=0\le x \le 1">, <img src="https://render.githubusercontent.com/render/math?math=x_i=\sin(0.5*\pi*x_1)">, which is not exactly the same as in the paper.
   =
# Cite Us:
